...
@section('content')
    ...
    <form method="post" action="{{route('activity.update',$activity)}}">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="name" id="name" placeholder="活动标题" value="{{$activity->name}}">
            {{csrf_field()}}
            {{method_field('PUT')}}
        </div>
        <div class="form-group">
            <label for="start_time">开始时间</label>
            <input type="date" name="start_time" class="form-control" id="start_time" placeholder="活动开始时间" value="{{date('Y-m-d',$activity->start_time)}}">
        </div>
        <div class="form-group">
            <label for="end_time">结束时间</label>
            <input type="date" name="end_time" class="form-control"
                   id="end_time" placeholder="活动开始时间" value="{{date('Y-m-d',$activity->end_time)}}">
        </div>
